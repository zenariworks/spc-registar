...
class Vencanje(models.Model):
    ...
    dan = models.ForeignKey(
        Dan, verbose_name="дан", on_delete=models.CASCADE, to_field="dan"
    )
    ...
    tasta = models.ForeignKey(
        Osoba, verbose_name="ташта", on_delete=models.CASCADE, related_name="ташта"
    )

    svekar = models.ForeignKey(
        Osoba, verbose_name="свекар", on_delete=models.CASCADE, related_name="свекар"
    )
    svekrva = models.ForeignKey(
        Osoba, verbose_name="свекрва", on_delete=models.CASCADE, related_name="свекрва"
    )
    ...
    kum = models.ForeignKey(
        Osoba, verbose_name="кум", on_delete=models.CASCADE, related_name="венчани_кум"
    )
