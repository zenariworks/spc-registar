...
urlpatterns = [
    ...
    path(
        "parohijan/<uuid:uid>/", views.ParohijanView.as_view(), name="parohijan_detail"
    ),
    path(
    ...
    path(
        "krstenje/<uuid:uid>/", views.KrstenjePrikaz.as_view(), name="krstenje_detail"
    ),
    path(
        "krstenje/print/<uuid:uid>/", views.KrstenjePDF.as_view(), name="krstenje_pdf"
    ),
    path("vencanja/", views.VencanjeSpisak.as_view(), name="vencanja"),
    path(
        "vencanje/<uuid:uid>/", views.VencanjePrikaz.as_view(), name="vencanje_detail"
    ),
    path(
