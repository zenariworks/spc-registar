...
data-driven из fixtures JSONL фајлова (по један JSON објекат у реду).
Slava има засебну логику (покретни празници из slave.jsonl) па се и даље
покреће као unos_slava.
...
SIFARNICI = [
    Sifarnik(Narodnost, "narodnosti.jsonl", ("naziv",)),
    Sifarnik(Veroispovest, "veroispovesti.jsonl", ("naziv",)),
    Sifarnik(Zanimanje, "zanimanja.jsonl", ("sifra", "naziv")),
