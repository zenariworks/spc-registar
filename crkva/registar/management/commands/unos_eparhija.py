...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        eparhije = [
            {"nivo": "Архиепископија", "naziv": "београдско-карловачка", "sediste": "Београд",},
            {"nivo": "Митрополија", "naziv": "аустралијско-новозеландска", "sediste": "Сиднеј",},
            {"nivo": "Митрополија", "naziv": "дабробосанска", "sediste": "Сарајево"},
            {"nivo": "Митрополија", "naziv": "загребачко-љубљанска", "sediste": "Загреб",},
            {"nivo": "Митрополија", "naziv": "црногорско-приморска", "sediste": "Цетиње"},
            ...
            {"nivo": "Епархија", "naziv": "британско-скандинавска", "sediste": "Лондон",},
            ...
            {"nivo": "Епархија", "naziv": "диселдорфска и немачка", "sediste": "Диселдорф",},
            {"nivo": "Епархија", "naziv": "жичка", "sediste": "Краљево"},
            {"nivo": "Епархија", "naziv": "западноамеричка", "sediste": "Сан Франциско",},
            {"nivo": "Епархија", "naziv": "западноевропска", "sediste": "Париз"},
            {"nivo": "Епархија", "naziv": "захумско-херцеговачка", "sediste": "Требиње",},
            ...
            {"nivo": "Епархија", "naziv": "новограчаничко-средњезападноамеричка", "sediste": "Чикаго",},
            {"nivo": "Епархија", "naziv": "осечкопољска и барањска", "sediste": "Осијек",},
            ...
            {"nivo": "Архиепископија", "naziv": "ПРАВОСЛАВНА ОХРИДСКА", "sediste": "Охрид",},
        ]
